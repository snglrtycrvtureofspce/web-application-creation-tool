...
if ($query->num_rows > 0) {
    ...
    echo "<table border='1'>";
    echo "<tr><th>ID</th><th>Логин</th><th>Действия</th></tr>";
    while ($row = $query->fetch_assoc()) {
        echo "<tr>";
        echo "<td>".$row['user_id']."</td>";
        echo "<td>".$row['user_login']."</td>";
        echo "<td><a href='edit_user.php?id=".$row['user_id']."'>Редактировать</a> | <a href='delete_user.php?id=".$row['user_id']."'>Удалить</a></td>";
        echo "</tr>";
    }
    echo "</table>";
} else {
